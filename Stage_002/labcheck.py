...
# parser.add_argument('-p','--password', required=True, type=str, help='remote password')
...
try: 
    ...
    try:
        ...
        # Memory
        stdin_memory, stdout_memory, stderr_memory = ssh.exec_command('free -g')
        ...
        Memory:  {memory_used}GB / {memory_total}GB ({memory_current_usage:.2f}% used)
